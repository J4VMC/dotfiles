...
(use-package multiple-cursors
  :ensure t
  :config
  (global-set-key (kbd "C-M-j") 'mc/edit-lines)                 ; Add cursor on next/prev line.
  (global-set-key (kbd "C->") 'mc/mark-next-like-this)          ; Add cursor at next matching word.
  (global-set-key (kbd "C-<") 'mc/mark-previous-like-this)      ; Add cursor at prev matching word.
  (global-set-key (kbd "C-c C-<") 'mc/mark-all-like-this)       ; Add cursors at ALL matching words.
