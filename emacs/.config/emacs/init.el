...
;; Reset the Garbage Collection (GC) threshold after startup finishes.
;; -> In `early-init.el`, we set this to 100MB to maximize load speed.
;; -> Here, we reset it to a balanced 32MB to keep Emacs responsive during use.
